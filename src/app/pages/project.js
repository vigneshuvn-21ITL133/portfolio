...
export default function Project() {
    ...
    <div className="grid grid-cols-3 m-10 gap-10 p-8 ml-32 shadow-lg rounded-sm">
    ...
    <div className="col-span-1 w-auto h-auto justify-center items-center">
     ...
     <a href='https://github.com/vigneshuvn-21ITL133/cricketwebsite.git'className='text-orange-600'>click here</a>
    </div>
    ...
    <div className="col-span-1 w-auto h-auto justify-center items-center">
     <Image src={project3} alt="project3" width={250} height={250} className='rounded-xl'/>
        ...
        <a href='https://github.com/vigneshuvn-21ITL133/blind-stick.git' className='text-orange-600'>click here</a>
    </div>
